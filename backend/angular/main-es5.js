...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    } //lazily loads the child module located at AuthModule
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./auth/auth.service */
    "./src/app/auth/auth.service.ts"); //import { Post } from './posts/post.model';
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _posts_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./posts.module */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_6__["HeaderComponent"], _error_error_component__WEBPACK_IMPORTED_MODULE_12__["ErrorComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_material_module__WEBPACK_IMPORTED_MODULE_7__["AngularMaterialModule"], _posts_module__WEBPACK_IMPORTED_MODULE_9__["PostsModule"]],
    ...
    })], AppModule); //it defines the feature
    ...
    function () {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate(route, state) {
          ...
          return isAuth; //throw new Error('Method not implemented');
        }
      }]);
  ...
  function srcAppAuthAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/environments/environment.ts"); //connecting Angular Auth service to the backend


    var BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/user/"; //common URL paths for HTTP API
      ...
      _createClass(AuthService, [{
        ...
        value: function createUser(email, password) {
          ...
          this.http.post(BACKEND_URL + 'signup', authData).subscribe(function () {
            _this.router.navigate["/"]; //redirection on signup comp. when signup successful
          }, function (error) {
            _this.authStatusListener.next(); //push the false value to entire app and inform that this will not be authenticated
        ...
        value: function login(email, password) {
          ...
          this.http.post(BACKEND_URL + 'login', authData).subscribe(function (response) {
            ...
            if (token) {
              ...
              _this2.authStatusListener.next(true); //informing everyone w/c component is interested abt the user being authenticated
              ...
              _this2.router.navigate(['/']); //nav back to the homepage

            }
          }, function (error) {
            _this2.authStatusListener.next(); //push the false value to entire app and inform that this will not be authenticated
        ...
        value: function autoAuthUser() {
          ...
          var now = new Date();
          var expiresIn = authInformation.expirationDate.getTime() - now.getTime(); //console.log(authInformation, expiresIn);
        ...
        value: function logout() {
          this.token = null;
          this.isAuthenticated = false;
          this.authStatusListener.next(false); //informing everyone w/c component is interested abt the user being not authenticated anymore (exiting login)
      ...
      _createClass(ErrorInterceptor, [{
        ...
        value: function intercept(req, next) {
          ...
          return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) {
            var errorMessage = 'An unknown error occurred!'; //console.log(error);
  ...
  function srcAppErrorErrorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ErrorComponent = //message = 'An unknown error occurred!';
  ...
  /***/
  function srcAppPostsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! @angular/router */
    "./node_modules/@angular/router/fesm2015/router.js"); //need to explicitly register this component so that the build process will able to scan the ts with app-post-create selector on it
    ...
    PostsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_posts_post_create_post_create_component__WEBPACK_IMPORTED_MODULE_2__["PostCreateComponent"], _posts_post_list_post_list_component__WEBPACK_IMPORTED_MODULE_3__["PostListComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_material_module__WEBPACK_IMPORTED_MODULE_6__["AngularMaterialModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"]]
    })], PostsModule);
    /***/
  },
    ...
    var mimeType = function mimeType(control) {
      ...
      var frObs = rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
        ...
        fileReader.addEventListener("loadend", function () {
          ...
          var arr = new Uint8Array(fileReader.result).subarray(0, 4); //allows us to access or to read certain patterns in the file but also in the form metadata that we can then use to parse the MIME type
  ...
  function srcAppPostsPostCreatePostCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ../../auth/auth.service */
    "./src/app/auth/auth.service.ts"); //more than just the template but it needs the template
    ...
    function () {
      function PostCreateComponent(postsService, route, authService) {
        ...
        this.route = route;
        this.authService = authService; //a variable within the class that doesn't need var, const or let
        //enteredTitle="";
        //enteredContent="";
      ...
      _createClass(PostCreateComponent, [{
        ...
        value: function onImagePicked(event) {
          ...
          this.form.patchValue({
            image: file
          }); //unlike setValue, you set the value for the single input or control

          this.form.get('image').updateValueAndValidity();
          var reader = new FileReader();

          reader.onload = function () {
            _this7.imgDisplay = reader.result;
    ...
    function () {
      ...
      _createClass(PostListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.isLoading = true; //Angular f(x) that automatically executes for me when it creates this component
  ...
  function srcAppPostsPostsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ../../environments/environment */
    "./src/environments/environment.ts"); //centralized some tasks and
    ...
    var BACKEND_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + "/posts/"; //common URL paths for HTTP API
    ...
    function () {
      ...
      _createClass(PostsService, [{
        ...
        value: function addPost(title, content, image) {
          ...
          var postData = new FormData(); //JSON can't include a file. So, instead of sending JSON, I'll send FormData
          //Prop. that we're trying to access on the backend, 'post.js'

          postData.append('title', title);
          postData.append('content', content);
          postData.append('image', image, title);
          this.http.post(BACKEND_URL, postData) //instead of PostId: string
          .subscribe(function (myData) {
            ...
            //emits a new value
            _this11.router.navigate(['/']); //nav back to the homepage
    ...
    PostsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }) //Angular doesn't only find it but it
    //creates the instance of service for the entire app
    ], PostsService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\lvclu\Documents\VinceMeanPrac1\vincemeanprac1\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
